...
p = [...
%%% BEGIN ENTRIES %%%
     '/sharing01/jhinno/data/spooler/renrong/0、matlab程序：图像局部放大，论文图像排列:', ...
     '/sharing01/jhinno/data/spooler/renrong/0、matlab程序：图像局部放大，论文图像排列/PSNR.SSIM:', ...
     '/sharing01/jhinno/data/spooler/renrong/0、matlab程序：图像局部放大，论文图像排列/PSNR.SSIM/quality_assess:', ...
     '/sharing01/jhinno/data/spooler/renrong/1、极大极小秩(-F范数)APG:', ...
     '/sharing01/jhinno/data/spooler/renrong/1、极大极小秩(-F范数)APG/Result_Einstein:', ...
     '/sharing01/jhinno/data/spooler/renrong/1、极大极小秩(-F范数)APG/result:', ...
     '/sharing01/jhinno/data/spooler/renrong/1、极大极小秩(-F范数)APG/result/admm:', ...
     '/sharing01/jhinno/data/spooler/renrong/1、极大极小秩(-F范数)APG/result/admm/image:', ...
     '/sharing01/jhinno/data/spooler/renrong/1、极大极小秩(-F范数)APG/result/apgl:', ...
     '/sharing01/jhinno/data/spooler/renrong/1、极大极小秩(-F范数)APG/result/apgl/image:', ...
     '/sharing01/jhinno/data/spooler/renrong/1、极大极小秩(-F范数)APG/tensor_toolbox:', ...
     '/sharing01/jhinno/data/spooler/renrong/1、极大极小秩(-F范数)APG/tensor_toolbox/doc:', ...
     '/sharing01/jhinno/data/spooler/renrong/1、极大极小秩(-F范数)APG/tensor_toolbox/doc/html:', ...
     '/sharing01/jhinno/data/spooler/renrong/1、极大极小秩(-F范数)APG/tensor_toolbox/doc/images:', ...
     '/sharing01/jhinno/data/spooler/renrong/1、极大极小秩(-F范数)APG/tensor_toolbox/met:', ...
     '/sharing01/jhinno/data/spooler/renrong/1、极大极小秩(-F范数)APG/千库网_故宫的雪景摄影图_摄影图编号96231:', ...
     '/sharing01/jhinno/data/spooler/renrong/0、图像:', ...
     '/sharing01/jhinno/data/spooler/renrong/0、图像/彩图:', ...
